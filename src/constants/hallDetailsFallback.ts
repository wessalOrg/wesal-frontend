...
export const DEMO_HALL_REVIEWS: HallReview[] = [
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "أعجبني مستوى النظافة والاهتمام بالتفاصيل. أنصح فيها للمناسبات الكبيرة، والطاقم متعاون جداً.",
    timeAgo: "منذ أسبوعين",
  },
  {
    id: "r4",
    ...
    rating: 5,
    comment:
      "من أجمل القاعات اللي تعاملنا معها. الدخول سلس والمواقف كافية، والحفل طلع بصورة راقية.",
    timeAgo: "منذ شهر",
  },
];
